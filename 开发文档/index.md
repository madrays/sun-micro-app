...
- [配置说明](./config) - app.config.js 与 components.config.js
- [数据节点](./data_node) - 数据存储、读取与作用域
- [权限声明](./permission) - 权限申请与风险说明
- [组件开发](./dev_guide) - 学习开发组件
- [UI 开发指南](./ui_guide) - 固定尺寸、调试台（刷新清单/元素复制/编辑模式）与最佳实践
- [平台 API](./api) - 调用平台能力
- [打包发布](./publish) - 构建、打包与发布流程
- [敏感配置安全实践](./敏感配置安全实践) - 敏感字段隐藏、模板替换、配置页展示策略
